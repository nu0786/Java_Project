...
public class AccountController {
    ...
    @PostMapping
    public ResponseEntity<TransactionServiceResponse> createAccount(@Valid @RequestBody AccountRequestDto accountRequest) throws ApiException {
    ...
    public ResponseEntity<TransactionServiceResponse> getAccount(@PathVariable Long accountId) throws ApiException {
